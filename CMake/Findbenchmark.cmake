...
set(benchmark_ROOT_DIR "benchmark_ROOT_DIR-NOTFOUND" CACHE PATH "Folder containing benchmark")
...
if(benchmark_FOUND)
  ...
  include(${benchmark_ROOT_DIR}/lib/cmake/benchmark/benchmarkConfig.cmake)
endif()
