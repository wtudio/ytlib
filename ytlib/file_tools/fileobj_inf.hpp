...
class FileObj {
 public:
  ...
  /**
   * @brief 打开并解析文件内容
   * @details 打开并解析文件内容到obj，同时设置path
   * @param path 文件路径
   */
  ...
  /**
   * @brief 打开并解析文件内容
   * @details 打开并解析文件内容到obj，使用设置好的path
   */
  void OpenFile() {
  ...
  /**
   * @brief 初始化内容结构体
   * @details 初始化内容结构体，同时会设置path，如果已经打开并解析了某个文件，则不会保存
   * @param path 文件路径
   */
  ...
  /**
   * @brief 初始化内容结构体
   * @details 初始化内容结构体，如果已经打开并解析了某个文件，则不会保存
   */
  void NewFile() {
    obj_ptr_.reset();
