...
class CliConnPool ：public std::enable_shared_from_this<CliConnPool> {
 public:
  ...
  // no copy
  CliConnPool(const CliConnPool&) = delete;
  CliConnPool& operator=(const CliConnPool&) = delete;
 ...
 private:
  ...
  class CliConn ：public std::enable_shared_from_this<CliConn> {
   public:
    ...
    // no copy
    CliConn(const CliConn&) = delete;
    CliConn& operator=(const CliConn&) = delete;
