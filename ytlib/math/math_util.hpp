 ...
 * @return 在指定位置前第一个1的位置。返回64表示没找到
 */
 ...
 * @return 等差数列的和
 */
double SumAP(double a1, double d, uint64_t n) {
 ...
 * @return 等比数列的和
 */
double SumGP(double a1, double q, uint64_t n) {
 ...
 * @return 等比数列的和
 */
double Pow(double value, uint64_t n) {
