...
TEST(HTTP_DISPATCHER_TEST, HttpDispatcher_CASE1) {
  ...
  dispatcher.RegisterHttpHandle("", []() -> std::string {
    return "CASE 1";
  });
...
TEST(HTTP_DISPATCHER_TEST, HttpDispatcher_CASE3) {
  ...
  TestHttpDispatcher dispatcher;
  dispatcher.RegisterHttpHandle("/path1/path2/.*", []() -> std::string {
    return "CASE 1";
  });

  dispatcher.RegisterHttpHandle("/path1/.*", []() -> std::string {
    return "CASE 2";
  });

  dispatcher.RegisterHttpHandle("/path3/path4/.*", []() -> std::string {
    return "CASE 3";
  });

  dispatcher.RegisterHttpHandle("/path5/.*/path6", []() -> std::string {
    return "CASE 4";
  });
