 ...
 */
  ...
  const std::string t_hfile_one_service_register_func = R"str(    RegisterRpcServiceFunc<{{rpc_req_name}}, {{rpc_rsp_name}}>("/{{package_name}}.{{service_name}}/{{rpc_func_name}}", std::bind(&{{service_name}}::{{rpc_func_name}}, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));)str";
