...
class UnifiedRpcCodeGenerator final : public google::protobuf::compiler::CodeGenerator {
 public:
  UnifiedRpcCodeGenerator() {}
  virtual ~UnifiedRpcCodeGenerator() {}

  const std::string t_ccfile = R"str(/**
 * @file {{file_name}}.unified_rpc_for_asio_rpc.pb.cc
 * @brief This file was generated by protoc-gen-unified_rpc_for_asio_rpc which is a self-defined pb compiler plugin, do not edit it!!!
 */
)str";

  const std::string t_hfile_one_service_register_func = R"str()str";

  const std::string t_hfile_one_service_func = R"str()str";

  const std::string t_hfile_one_service_class = R"str()str";

  const std::string t_hfile_one_service_proxy_func = R"str()str";

  const std::string t_hfile_one_service_proxy_class = R"str()str";

  const std::string t_hfile = R"str(/**
 * @file {{file_name}}.unified_rpc_for_asio_rpc.pb.h
 * @brief This file was generated by protoc-gen-unified_rpc_for_asio_rpc which is a self-defined pb compiler plugin, do not edit it!!!
 */
#pragma once
...
{{service_proxy_class}}
  ...
  bool Generate(const google::protobuf::FileDescriptor* file, const std::string& parameter,
    ...
    WriteToFile(context, file_name + ".unified_rpc_for_asio_rpc.pb.cc", ccfile);
    ...
    WriteToFile(context, file_name + ".unified_rpc_for_asio_rpc.pb.h", hfile);
...
int main(int argc, char* argv[]) {
  ytlib::ytrpc::UnifiedRpcCodeGenerator generator;
