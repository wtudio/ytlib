...
class AsioRpcStatus {
 ...
 public:
  ...
  AsioRpcStatus(AsioRpcStatus::Code ret, int func_ret = 0, const std::string& func_ret_msg = "")
      : ret_(ret),
        func_ret_(func_ret),
        func_ret_msg_(func_ret_msg) {}
  ...
  const AsioRpcStatus::Code& Ret() const { return ret_; }
 ...
 private:
  AsioRpcStatus::Code ret_ = AsioRpcStatus::Code::OK;  // 框架层面错误码
