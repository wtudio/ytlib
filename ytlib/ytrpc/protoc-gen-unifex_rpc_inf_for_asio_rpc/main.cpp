 ...
 * @file {{file_name}}.unifex_rpc_inf_for_asio_rpc.pb.cc
 * @brief This file was generated by protoc-gen-unifex_rpc_inf_for_asio_rpc which is a self-defined pb compiler plugin, do not edit it!!!
 */
)str";
 ...
 * @file {{file_name}}.unifex_rpc_inf_for_asio_rpc.pb.h
 * @brief This file was generated by protoc-gen-unifex_rpc_inf_for_asio_rpc which is a self-defined pb compiler plugin, do not edit it!!!
 */
#pragma once
...
#include "ytlib/ytrpc/unifex_rpc_inf/unifex_rpc_client_inf.hpp"
...
{{service_proxy_class}}
  ...
  bool Generate(const google::protobuf::FileDescriptor* file, const std::string& parameter,
    ...
    WriteToFile(context, file_name + ".unifex_rpc_inf_for_asio_rpc.pb.cc", ccfile);
    ...
    WriteToFile(context, file_name + ".unifex_rpc_inf_for_asio_rpc.pb.h", hfile);
