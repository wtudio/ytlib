# add target for unifex rpc gen code target for proto files
function(add_protobuf_unifex_rpc_gencode_target_for_proto_files)
  ...
  foreach(PROTO_FILE ${ARG_PROTO_FILES})
    ...
    add_custom_command(
      ...
      COMMAND protobuf::protoc ARGS ${ARG_OPTIONS} --proto_path ${PROTO_FILE_PATH} ${PROTOC_EXTERNAL_PROTO_PATH_ARGS} --unifex_rpc_out
              ${ARG_GENCODE_PATH} --plugin=protoc-gen-unifex_rpc=$<TARGET_FILE:ytlib::ytrpc::protoc-gen-unifex_rpc> ${PROTO_FILE}
      DEPENDS ${PROTO_FILE} protobuf::protoc ytlib::ytrpc::protoc-gen-unifex_rpc
      COMMENT
        "Running protoc, args: ${ARG_OPTIONS} --proto_path ${PROTO_FILE_PATH} ${PROTOC_EXTERNAL_PROTO_PATH_ARGS} --unifex_rpc_out ${ARG_GENCODE_PATH} --plugin=protoc-gen-unifex_rpc=$<TARGET_FILE:ytlib::ytrpc::protoc-gen-unifex_rpc> ${PROTO_FILE}"
      VERBATIM)
  endforeach()
  ...
  target_link_libraries(${ARG_TARGET_NAME} PUBLIC ytlib::ytrpc::unifex_rpc ${ALL_DEP_PROTO_TARGETS})
