...
function(add_unifex_rpc_gencode_for_one_file_target)
  ...
  add_custom_command(
    ...
    ARGS ${ARG_OPTIONS} --proto_path ${PROTO_PATH} --unifex_rpc_out ${ARG_GENCODE_PATH} --plugin=protoc-gen-unifex_rpc=$<TARGET_FILE:ytlib::ytrpc::protoc-gen-unifex_rpc> ${ARG_PROTO_FILE}
    DEPENDS ${ARG_PROTO_FILE} protobuf::protoc ytlib::ytrpc::protoc-gen-unifex_rpc
    COMMENT "Running protoc, args: ${ARG_OPTIONS} --proto_path ${PROTO_PATH} --unifex_rpc_out ${ARG_GENCODE_PATH} --plugin=protoc-gen-unifex_rpc=$<TARGET_FILE:ytlib::ytrpc::protoc-gen-unifex_rpc> ${ARG_PROTO_FILE}"
    VERBATIM
  )
