...
RotateFileWriter::RotateFileWriter() : rotate_type_(RotateType::RotateByTime) {}
...
void RotateFileWriter::SetMaxFileNum(uint32_t max_file_num) {
  max_file_num_ = max_file_num;
}

void RotateFileWriter::SetRotateType(RotateType type) {
  rotate_type_ = type;
}
...
uint32_t RotateFileWriter::GetNextIndex() {
  uint32_t idx = 1;
...
void RotateFileWriter::CleanLogFile() {
